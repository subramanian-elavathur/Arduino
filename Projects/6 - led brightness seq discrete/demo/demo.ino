...
void loop()
{
   for(i=0;i<=10000;i++){  
      ...
      x = x+1;
      analogWrite(ledPin1, ledLevel1); delay(10);}
      
      if(y>=0 && y<255){
      ledLevel2 = ledLevel2 + 1;
      y = y+1;
      analogWrite(ledPin2, ledLevel2); delay(10);}
      
      if(z>=0 && z<255){
      ledLevel3 = ledLevel3 + 1;
      z = z+1;
      analogWrite(ledPin3, ledLevel3); delay(10);}
      
      if(w>=0 && w<255){
      ledLevel4 = ledLevel4 + 1;
      w = w+1;
      analogWrite(ledPin4, ledLevel4); delay(10);}
